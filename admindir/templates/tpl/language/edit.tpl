   ...
   <div class="main">
      ...
      <div class="right_content">
         ...
         <form name="allsubmit" id="frmEdit"
            action="index.php?do=language&act={$actType}"
            method="post"
                  ...
                  <div class="left100">
                     <div class="item">
                        ...
                        <div class="info-title">
                           <input type="text"
                              value="{$edit.name|default:''|escape:'html':'UTF-8'}"
                              name="name"
                              class="InputText" />
                        </div>
                     </div>
                     ...
                     <div class="item">
                        <div class="title">
                           ...
                           <input type="checkbox" class="CheckBox" name="active" value="active"
                              {if $edit.active eq 1 or $smarty.request.act=='add' }checked{/if} />
                        </div>
                     </div>
                  </div>
               </div>
