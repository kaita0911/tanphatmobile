...
<!-- <a href="https://m.me/thegioithietbiphache/" class="support-ic sms-icon" rel="nofollow">
      <img src="{$path_url}/assets/images/ic_messenger.png" alt="Messenger">
   </a> -->

<!-- Zalo -->
<a href="http://zalo.me/0903949329" target="_blank" class="support-ic zalo" rel="nofollow">
   <img src="{$path_url}/assets/images/ic__zalo.png" alt="Zalo">
</a>

<!-- Call -->
<a href="tel:{$hotline.phone}" class="support-ic call-icon" rel="nofollow">
   <span><img src="{$path_url}/assets/images/telephone.png" alt="Call"></span>
</a>


<!-- Nội dung script từ CMS -->
{$bodyscript.content_vn nofilter}
<script>
   var zalo_qr = "{$hotline.plain_text_vn|escape:'javascript'}";
</script>
{literal}
<script>
   var zalo_acc = {
